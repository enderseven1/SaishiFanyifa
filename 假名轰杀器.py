...
dict1 = {'結': '结', '収': '收', '賄': '贿', '窮': '穷', '腎': '肾', '虜': '虏', '読': '读', '臨': '临', '貞': '贞', '脈': '脉', '躍': '跃', '組': '组', '薬': '药', '穂': '穗', '戸': '户', 
        ...
        '渋': '涩', '壊': '怀', '憲': '宪', '円': '圆', '権': '权', '慣': '惯', '欠': '缺', '夢': '梦', '話': '话', '獣': '兽', '閉': '闭', '砲': '炮', '離': '离', '殺': '杀', '鉄': '铁', 
        ...
        'ｔ': 't', 'ｕ': 'u', 'ｖ': 'v', 'ｗ': 'w', 'ｘ': 'x', 'ｙ': 'y', 'ｚ': 'z', '、': '，', '・': '、', '「': '“', '『': '‘', '』': '’', '」': '”', '\u3000': ' ', '條': '条', '絢': '绚', 
        '澤': '泽', '濁': '浊', '駿': '骏', '綾': '绫', '繚': '缭', '譚': '谭', '龍': '龙', '鷹': '鹰', '蒼': '苍'}
fd = []
while True:
    c = input('请输入你要轰杀假名的日语：\n')
    for dfg in c:
        fd += dfg
